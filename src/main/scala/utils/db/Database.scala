...
case class GiveAway(idGiveAways:Int, nomGiveAways:String, usersMap: Map[Int, User] = Map[Int, User]())
...
object Database {
  ...
  var GIVEAWAYS_MAP: Map[Int, GiveAway] = Map((0, GiveAway(0, "Aidez moi c'est un appel a l'aide")))
